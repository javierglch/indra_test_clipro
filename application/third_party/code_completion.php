 ...
 * @property Form                $form                                Form Class
 * @property EmailManager        $emailmanager                        EmailManager Class
 * @property ResponseManager     $responsemanager                     ResponseManager Class
 * @property usersession         $usersession                         UserSession Class
 * @property structureddata      $structureddata                      StructuredData Class
 * @property TwitterAPIExchange  $twitterapiexchange                  TwitterAPIExchange Class
 * @property ChampionAnalysis  $championanalysis                      ChampionAnalysis Class
 * 
 */
class CI_Controller {
